...
<section class="container text-center  align-content-center">
    ...
    <header class="d-flex  justify-content-between">
      ...
      <section>
        <button class="btn btn-warning " type="button"data-bs-toggle="modal" data-bs-target="#modal_reutilizable_materia_alumno" id="createButtonMateria">
...
<!-- 
    <section class="table-responsive">
        <table class="table" id="table_materia">
            <thead>
                <tr>
                    <th scope="col">#</th> 
